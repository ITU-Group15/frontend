...
export default class CreateChannel extends Component<{}> {
  ...
  _addChannel = () => {
    ...
    fetch('https://channelbapd.herokuapp.com/create', {
        ...
        .then((res) => {
            if (res.code == 0){
              ExportNative.show("Channel is added successfully.", ExportNative.SHORT);
            }
            else
    ...
    return(
      <View>
        ...
        <View style={styles.header}>
          <Text style= {{fontSize: 20, padding: 15, color: '#fff'}}>Create Channel</Text>
        </View>
